...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        for (ex,ey,ew,eh) in eyes:
            ...
            if ew > 60 and eh > 30:
                cv2.putText(frame, "Eye glasses detected", (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2)
            else:
                cv2.putText(frame, "No eye glasses detected", (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,0,255), 2)
